...
{
    public class AccomodationListViewModel : BaseViewModel
    {
        ...
        public AccomodationListViewModel(/*INavigation navigation*/)
        {
        ...
        async Task LoadList()
        {
            try
            {
                ...
                {
                    if(item.Type == LocationType.Hotel.ToString() || item.Type == LocationType.Hostel.ToString() || item.Type == LocationType.GuestHouse.ToString())
                    {
                        Items.Add(item);
                    }
                }
