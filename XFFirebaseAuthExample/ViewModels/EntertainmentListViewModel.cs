...
{
    public class EntertainmentListViewModel : BaseViewModel
    {
        ...
        public EntertainmentListViewModel(/*INavigation navigation*/)
        {
        ...
        async Task LoadList()
        {
            try
            {
                ...
                {
                    if(item.Type == LocationType.Coffee.ToString() || item.Type == LocationType.Restaurant.ToString() || item.Type == LocationType.Theatre.ToString())
                    {
                        Items.Add(item);
                    }
                }
